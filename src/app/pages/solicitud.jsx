...
const Solicitud = (props) => {
    ...
    return (
        <Grid container rowSpacing={3} direction={{ xs: 'column', md: 'row' }} justifyContent="center" textAlign="center" maxWidth="xl" sx={{ bgcolor: '#cfe8fc', borderRadius: 1, mt: 3, background: 'linear-gradient(to bottom, #F8F8F8, #FFFFFF)' }}>
