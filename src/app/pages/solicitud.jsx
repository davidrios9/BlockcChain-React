...
const Solicitud = (props) => {
    ...
    return (
        <Grid container rowSpacing={1} justifyContent="center" align='center' maxWidth="xl" direction={{ xs: 'column', md: 'row' }} sx={{ display: 'flex', bgcolor: '#cfe8fc', minHeight: '80vh', borderRadius: 1, background: 'linear-gradient(to bottom, #F8F8F8, #FFFFFF)' }}>
            ...
            <Grid item xs={6} > <Button onClick={() => navegar("actualizacionDoc")} variant="contained" sx={{ width: { xs: '90vw', sm: '90vw', md: '40vw' }, height: { xs: '10vh', sm: '10vh', md: '20vh' } }} color="pink" ><Typography sx={{ typography: { xs: 'h6', sm: 'h6', md: 'h3', lg: 'h3' } }}>Sustitución de documentos</Typography></Button></Grid>
            <Grid item xs={6} > <Button onClick={() => navegar("cambioNombreDoc")} variant="contained" sx={{ width: { xs: '90vw', sm: '90vw', md: '40vw' }, height: { xs: '10vh', sm: '10vh', md: '20vh' } }} color="orange" ><Typography sx={{ typography: { xs: 'h6', sm: 'h6', md: 'h3', lg: 'h3' } }}>Edición o eliminación de documentos</Typography></Button></Grid>
