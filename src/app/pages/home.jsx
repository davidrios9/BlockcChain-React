...
const Home = (props) => {
    if(sessionStorage.getItem("token") === null){
        return (
            ...
            <Grid container justifyContent="center" maxWidth="xl" direction={{xs: 'column', md: 'row' }}  sx={{ display: 'flex', alignItems: 'center', bgcolor: '#cfe8fc', minHeight: '80vh', borderRadius: 1, mt: 1, background: 'linear-gradient(to bottom, #F8F8F8, #FFFFFF)' }}>
                <Grid item xs={6} >
